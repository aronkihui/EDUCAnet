    ...
    <section class="contexpandido">                    
            <section class="contenedorexp">
                    ...
                    <?php
                            ...
                            $asignatura = Asignaturacomun::model()->find(array(
                                                        'condition'=>'idasignaturacomun = :asignaturaID',
                                                        'params'=>array(':asignaturaID'=>$idasignatura),
                                                )); 
                    ?>
                                    ...
                                    <table border="0" bordercolor="gray">
                                            <tr><td class="celdanombre"><?php echo $data->nombre; ?> <?php echo $data->apellido; ?></td></tr>
                                                    ...
                                                    <?php
                                                            $notasi = Notas::model()->findAll(array(
                                                                    ...
                                                                    'params'=>array(':asignaturacomunID'=>$idasignatura),
                                                            ));
                                                    ?>
                                            ...
                                            <td class='celdat'> 
                                                    <?php echo CHtml::beginForm(); ?>
                                                                    ...
                                                                    <?php $notas->asignaturacomun_idasignaturacomun = $asignatura->idasignaturacomun; ?>
                                                                    <?php $notas->alumno_idalumno = $data->idalumno; ?>                                                                                                                                             
                                                                    <?php echo CHtml::submitButton('Ingresar', array('class'=>'btn btn-primary', 'submit' => array('/profesor/notas', 'idcurso'=>$data->cursocomun_idcurso, 'idasignatura'=>$asignatura->idasignaturacomun,'seleccion'=>$asignatura->nomasigcomun, 'idalumno'=>$data->idalumno))); ?>
