    ...
    <section class="contexpandido">
            <section class="contenedorexp">
                    ...
                    <?php foreach ($array_destino as $data): ?> 
                            <?php echo CHtml::button($data->nombrecurso ,array('class'=>'btn btn-primary', 'submit' => array('/profesor/mostraralumnos', 'idcurso'=>$data->idcurso, 'seleccion'=>$data->nombrecurso))); ?>   
                        <br></br>
                    <?php endforeach; ?>
                    ...
                    if($idelectivos !== NULL):?>
                            ...
                            <?php endforeach; ?>
                            <?php foreach ($array_destino as $data): ?> 
                                    <?php echo CHtml::button($data->nombrecurso ,array('class'=>'btn btn-primary', 'submit' => array('/profesor/mostraralumnoselectivo', 'idcurso'=>$data->idcursoelectivo, 'seleccion'=>$data->nombrecurso))); ?>   
                                <br></br>
                            <?php endforeach; ?>
                            <?php foreach ($electivos as $data): ?> 
