...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->labelEx($model,'cursocomun_idcurso'); ?>
		<?php echo $form->textField($model,'cursocomun_idcurso'); ?>
		<?php echo $form->error($model,'cursocomun_idcurso'); ?>
	</div>

	<div class="row">
		<?php echo $form->labelEx($model,'cursoelectivo_idcursoelectivo'); ?>
		<?php echo $form->textField($model,'cursoelectivo_idcursoelectivo'); ?>
		<?php echo $form->error($model,'cursoelectivo_idcursoelectivo'); ?>
	</div>
